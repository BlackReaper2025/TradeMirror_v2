...
export function AppShell({ children }: AppShellProps) {
  ...
  return (
    ...
    >
      ...
      >
        {activePage !== "analytics-v3" && activePage !== "trade-log" && activePage !== "ai-positioning" && <RadialGlowBackground />}
        {(["dashboard", "trade-log", "calendar", "analytics-v3", "ai-positioning", "risk-calculator", "settings"] as Page[]).map(p => (
